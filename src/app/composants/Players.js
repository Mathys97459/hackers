...
export default function Players({ setShowPlayers }) {
    ...
    return (
        <main className="w-100 bg-[url('/img/moon.png')] bg-cover bg-center bg-fixed flex flex-col items-center pt-6 transition-all duration-300">
            ...
            <div
                className="fixed top-full -translate-y-full bg-gradient-to-b from-zinc-950 to-purple-950 h-36 cursor-pointer z-50 flex items-center justify-center gap-1 md:w-2/5 w-full"
